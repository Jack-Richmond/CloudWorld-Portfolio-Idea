  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        ...
        <div className='py-16'>
          <h3 className='subhead-text'>Project Outline</h3>
            <div className='mt-5 flex flex-col gap-3 text-slate-500'>
            <p>Working with multiple companies levelling up skills and bringing a strong team to a game changing idea. Heres the rundown:</p>
          </div>
